<x-account-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if (count($messages) === 0)
                <h4 class="text-center">{{ __('No emails have already been sent.') }}</h4>
            @else
                <div class="table table-detail mail-right">
                    <div class="row">
                        <div class="row m-t-0 ml-2 m-b-30 mr-2 table-responsive">
                            <table id="datatable" class="table-hover mails P-2 table-responsive table dataTable">
                                ...
                                <tbody>
                                    @foreach ($messages as $message)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('gmail.detail.sent', "$message->id") }}"
                                                    class="inbox-subject-column">
                                            ...
                                            <td><a href="{{ route('gmail.detail.sent', "$message->id") }}"
                                                    class="inbox-mail-column">{{ $message->getSnippet() }}...</a>
                                            </td>
                                            <td><a href="{{ route('gmail.detail.sent', "$message->id") }}"
                                                    class="inbox-mail-column">{{ date('Y-m-d H:i:s', $message->getInternalDate() / 1000) }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
