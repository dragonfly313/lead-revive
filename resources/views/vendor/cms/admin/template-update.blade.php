...
<?php if (config("cms.bootstrap-version") == 5) { ?>
    @include('cms::admin/template-update/bootstrap-5/header')
<?php } else { ?>
    @include('cms::admin/template-update/bootstrap-4/header')
<?php } ?>
@stop
...
<?php if (config("cms.bootstrap-version") == 5) { ?>
    @include('cms::admin/template-update/bootstrap-5/content')
<?php } else { ?>
    @include('cms::admin/template-update/bootstrap-4/content')
<?php } ?>
@stop
