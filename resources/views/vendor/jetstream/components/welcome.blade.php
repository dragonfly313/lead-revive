<div class="pt-4 my-5 row justify-content-center">
    <div class="col-md-12">
        <div class="shadow card bg-light">
            <div class="px-5 py-3 bg-white card-body border-bottom rounded-top">
                ...
                <h3 class="my-4 h3">
                    {{ __('Welcome to your Lead Revivier application!') }}
                </h3>

                <div class="text-muted">
                    Lead Reviver provides a beautiful, robust starting point for your next Laravel Saas application. Laravel is designed
                                ...
                                <a href="https://laravel.com/docs" class="text-decoration-none">
                                    <div class="mt-3 d-flex align-content-center font-weight-bold text-primary">
                                        ...
                                        <div class="ml-1 text-primary">
                                            <svg viewBox="0 0 20 20" fill="currentColor" width="16" class="w-4 h-4 arrow-right"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                        </div>
                                    </div>
                                </a>
                            </div>
