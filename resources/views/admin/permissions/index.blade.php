...
<div class="container">
    <div class="row">
        ...
        <a href="{{ route('admin.users.index') }}" class="btn btn-outline-primary btn-sm float-right mr-2">Users</a>
        <a href="{{ route('admin.roles.index') }}" class="btn btn-outline-primary btn-sm float-right mr-3">Roles</a>
        </div>
    </div>
    <hr>
