<nav class="navbar navbar-top navbar-expand navbar-light bg-secondary border-bottom" style="position: sticky; top: 0;">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="hs-unfold">
                <a class="pr-0 nav-link btn btn-outline-info" href="#" role="button" data-toggle="dropdown"
                    style="background-color:transparent; border:0px;" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="navbar-nav align-items-center ml-md-auto">
                ...
                <li class="nav-item dropdown pr-4">
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                        <a class="pr-0 nav-link btn btn-outline-info" href="#" role="button"
                            data-toggle="dropdown" style="border:0px;" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center">
                                <div class="ml-2 media-body d-none d-lg-block">
                                    {{ Auth::user()->currentTeam->name }}
                                    <svg class="ml-0 mb-1 mr-2 text-success" width="20" fill="none"
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <div class="py-3 card-body">
                            ...
                            <a class="px-0 dropdown-item" href="{{ route('unsyncGmailPage') }}">
                              <span class="dropdown-item-icon">
                                  <i class="fas fa-unlock-alt"></i>
                              </span>
                              {{ __('UnSync') }}
                          </a>
                            <a class="px-0 dropdown-item" href="{{ route('logout') }}"
