    ...
    <div class="u-sidebar-inner">
        <header class="u-sidebar-header">
            <a class="u-sidebar-logo" href="{{ route('admin.index') }}">
                <img class="img-fluid" src="{{ asset('saas/img/logo.png') }}" width="124" alt="Saasify Dashboard">
            </a>
        </header>
            ...
            <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                ...
                <li class="u-sidebar-nav-menu__item">
                    ...
                    <ul id="baseUI" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: none;">
                        ...
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="{{ route('admin.activity') }}">
                                <span class="u-sidebar-nav-menu__item-icon">
                                    <i class="fas fa-user"></i>
                                </span>
                                <span class="u-sidebar-nav-menu__item-title">{{ __('Activity') }}</span>
                            </a>
                        </li>
                        <li class="u-sidebar-nav-menu__item">
