  ...
  <div class="container">
    ...
    <div class="space-top-2 space-bottom-1 space-bottom-lg-2">
      <div class="row justify-content-lg-between">
        <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
          <!-- Logo -->
          <div class="mb-4">
            <a href="/" aria-label="Lead Reviver">
              <h2 style="color:white">{{ __('Lead Reviver') }}</h2>
            </a>
          </div>
          <!-- End Logo -->
    ...
    <div class="space-1">
      ...
      <div class="w-md-75 text-lg-center mx-lg-auto">
        <p class="text-white opacity-sm small">&copy; Lead Reviver. {{ date('Y') }} {{ __('All rights reserved.') }}</p>
