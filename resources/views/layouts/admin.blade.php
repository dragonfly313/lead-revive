...
<body>
    ...
    <header class="u-header">
        <div class="u-header-middle">
			<a class="navbar-brand" href="{{ route('home') }}">
				<img src="{{ asset('saas/img/logo.png') }}" class="navbar-brand-img" alt="knine"
					style="max-height: 2rem;padding-left: 12px;">
			</a>
            ...
            <div class="u-header-search" data-search-mobile-invoker="#headerSearchMobileInvoker"
                ...
                <a id="headerSearchMobileInvoker"
                    class="btn btn-link input-group-prepend u-header-search__mobile-invoker" href="#!">
                ...
                <div id="headerSearch" class="u-header-search-form">
                    <form>
                        <div class="input-group">
                            ...
                            <input class="form-control u-header-search__field" type="search"
        ...
        <div class="u-header-right">
            ...
            <div class="ml-2 dropdown">
                <a class="link-muted d-flex align-items-center" href="#!" role="button" id="dropdownMenuLink"
                    ...
                    <img class="mr-2 u-avatar--xs img-fluid rounded-circle" src="{{ Auth::user()->profile_photo_url }}"
                        alt="User Profile">
                ...
                <div class="py-0 mt-3 border-0 dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink"
                    style="width: 260px;">
                    <div class="card">
                        <div class="card-body">
                            <ul class="mb-0 list-unstyled">
                                <li class="mb-4">
                                    <a class="d-flex align-items-center link-dark" href="{{ url('user/profile') }}">
                                        <span class="mb-0 h3"><i class="mr-3 far fa-user-circle text-muted"></i></span>
                                        {{ __('Profile') }}
                                    </a>
                                </li>
                                <li>
    ...
    <main class="u-main" role="main">
        ...
        <div class="u-content" style="top: 40px;">
