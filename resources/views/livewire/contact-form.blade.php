<div class="container space-2 space-lg-3">
    ...
    <div class="mb-5 text-center w-md-80 w-lg-50 mx-md-auto mb-md-9">
        <h2 id="contactTitle">{{ __('Tell us about yourself or your business') }}</h2>
        <p id="contactSubtitle">{{ __('Whether you have questions or you would just like to say hello, contact us.') }}</p>
    </div>
    <!-- End Title -->
    ...
    <div class="mx-auto w-lg-80">
        ...
        <form wire:submit.prevent="contactFormSubmit" action="/contact" method="POST" class="w-full">
            ...
            <div class="text-center mt-4">
                <button id="contactSubmitBtn" type="submit" class="btn btn-primary contact-submit">{{ __('Submit') }}</button>
            </div>
        </form>
        <!-- End Contacts Form -->
    </div>
